...
This document is the canonical UI/UX context for all current and future frontend module work in `careverse_regulator`.
...
Careverse Regulator is a company-scoped (regulator-scoped) operational portal for licensing and compliance operations.
